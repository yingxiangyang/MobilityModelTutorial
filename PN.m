%adding preferential return
rho=0.6;
gamma=0.21;
load /Users/yingxiangyang/Documents/Scaling/ScalingOriginal/PN/PT.txt %144 slots, 
Parameters=load('Parameters.txt');
Parameters(:,3)=Parameters(:,3)/7;
