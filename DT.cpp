...
int main(int argc, char** argv){
	...
	file_name0="/home/yingxiang/Scaling/DT/StayRegionFiltered.txt";
	file_name1 = "DTReal.txt";
	file_name2 = "DTSimu.txt";
	file_name3 = "DNReal.txt";
	file_name4 = "DNSimu.txt";
	file_name5 = "SimuLoc.txt";
    file_name6 = "Parameters.txt";
	...
	while (getline(fid_in,tline)){
		...
		if (num1==person_id){
			...
			if (stay_num>min_num_stay && stay_num<max_num_stay){
				...
				//if not interpolated, do not permit disorder
				//if interpolated, sort the time
				if (!interpolated){
	...
	while (getline(fid_in1,tline)){
		...
		if (num1==person_id){
			...
			if (stay_num>min_num_stay && stay_num<max_num_stay){
					...
					for (int index1=0; index1<index1_num; index1++){
						for (int index2=0; index2<index2_num; index2++){
							...
							if (ats<best_ats){
								...
								best_index2=index2;
								best_sf=index_sf;
								best_simu_time=simulated_time; //should be deep copy
				...
				//cout<<best_index1<<" "<<best_index2<<" "<<best_nw/7.0<<endl;
